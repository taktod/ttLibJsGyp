  ...
  "targets": [
    {
      ...
      "sources": [
        ...
        "ttLibC/ttLibC/decoder/audioConverterDecoder.c",
        "ttLibC/ttLibC/decoder/avcodecDecoder.c",
        "ttLibC/ttLibC/decoder/jpegDecoder.c",
        "ttLibC/ttLibC/decoder/mp3lameDecoder.c",
        "ttLibC/ttLibC/decoder/openh264Decoder.cpp",
        "ttLibC/ttLibC/decoder/opusDecoder.c",
        "ttLibC/ttLibC/decoder/pngDecoder.c",
        "ttLibC/ttLibC/decoder/speexDecoder.c",
        "ttLibC/ttLibC/decoder/theoraDecoder.c",
        "ttLibC/ttLibC/decoder/vorbisDecoder.c",
        "ttLibC/ttLibC/decoder/vtDecompressSessionDecoder.c",
        ...
        "ttLibC/ttLibC/encoder/speexEncoder.c",
        "ttLibC/ttLibC/encoder/theoraEncoder.c",
        "ttLibC/ttLibC/encoder/vorbisEncoder.c",
        ...
        "ttLibC/ttLibC/resampler/libyuvResampler.c",
      ...
      "sources": [
        ...
        "csrc/decoder/jpegDecoder.cpp",
        "csrc/decoder/mp3lameDecoder.cpp",
        "csrc/decoder/openh264Decoder.cpp",
        "csrc/decoder/opusDecoder.cpp",
        "csrc/decoder/pngDecoder.cpp",
        "csrc/decoder/speexDecoder.cpp",
        "csrc/decoder/theoraDecoder.cpp",
        "csrc/decoder/vorbisDecoder.cpp",
        "csrc/decoder/vtDecompressSessionDecoder.cpp",
        "csrc/encoder.cpp",
        "csrc/encoder/audioConverterEncoder.cpp",
        "csrc/encoder/faacEncoder.cpp",
        "csrc/encoder/fdkaacEncoder.cpp",
        "csrc/encoder/jpegEncoder.cpp",
        "csrc/encoder/mp3lameEncoder.cpp",
        "csrc/encoder/msAacEncoder.cpp",
        "csrc/encoder/msH264Encoder.cpp",
        "csrc/encoder/openh264Encoder.cpp",
        "csrc/encoder/opusEncoder.cpp",
        "csrc/encoder/speexEncoder.cpp",
        "csrc/encoder/theoraEncoder.cpp",
        "csrc/encoder/vorbisEncoder.cpp",
        "csrc/encoder/vtCompressSessionEncoder.cpp",
        "csrc/encoder/x264Encoder.cpp",
        "csrc/encoder/x265Encoder.cpp",
        "csrc/resampler.cpp",
        "csrc/resampler/audioResampler.cpp",
        "csrc/resampler/imageResampler.cpp",
        "csrc/resampler/libyuvRotateResampler.cpp",
        "csrc/resampler/libyuvScaleResampler.cpp",
        "csrc/resampler/soundtouchResampler.cpp",
        "csrc/resampler/speexdspResampler.cpp",
        "csrc/resampler/swresampleResampler.cpp",
        "csrc/resampler/swscaleResampler.cpp",
        "csrc/msLoopback.cpp",
        "csrc/msSetup.cpp"
      ],
      "libraries": [
